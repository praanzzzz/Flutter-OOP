...
class MyHomePage extends StatelessWidget {
  ...
  //using function: flexibility, can have logig, can accept parameters
  Widget _buildDetailsSection() {
    return Column(
      ...
      children: [
        ...
        _buildSocialRow(Icons.mail, 'franzgabijan55@gmail.com'),
        _buildSocialRow(Icons.facebook, 'Franz Anthony D. Gabijan'),
      ],
    );
  }
